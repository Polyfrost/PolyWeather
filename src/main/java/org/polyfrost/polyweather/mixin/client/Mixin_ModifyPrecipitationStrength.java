...
public class Mixin_ModifyPrecipitationStrength {
    @WrapOperation(method = /*? if >=1.21.10 {*/ "extractRenderState" /*?} else if >=1.21.4 {*/ /*"render(Lnet/minecraft/world/level/Level;Lnet/minecraft/client/renderer/MultiBufferSource;IFLnet/minecraft/world/phys/Vec3;)V" *//*?} else {*/ /*"renderSnowAndRain" *//*?}*/, at = @At(value = "INVOKE", target = /*? if >=26.2 {*/ "Lnet/minecraft/client/multiplayer/ClientLevel;getRainLevel(F)F" /*?} else if >=1.21.4 {*/ /*"Lnet/minecraft/world/level/Level;getRainLevel(F)F" *//*?} else {*/ /*"Lnet/minecraft/client/multiplayer/ClientLevel;getRainLevel(F)F" *//*?}*/))
    private float modifyPrecipitationStrength(/*? if >=26.2 {*/ ClientLevel /*?} else if >=1.21.4 {*/ /*Level *//*?} else {*/ /*ClientLevel *//*?}*/ instance, float delta, Operation<Float> original) {
